// Programa que lẽ salario bruto de uma pesoa,e calcula salario liquido baseado na  taxa de imposto de renda e taxa de inss.
...
int main(void){
  ...
  float salario_bruto, imp_renda, tx_inss;
  char nome[TAM_NOME];
